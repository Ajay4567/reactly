            ...
            "subcategories": [
                {
                    ...
                    "filters": {
                        ...
                        "Special Diet": ["Grain-Free", "Weight Management", "Hypoallergenic"],
    ...
    return (
        <>
            ...
            <header className="header">
                ...
                <div className="auth-options">
                    {user ? (
                        ...
                        <>
                            <button onClick={() => setIsModalOpen(true)} className="auth-link">Sign In</button>
                            <SignInModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />

                            <button onClick={() => setShowModal(true)}>Sign In Model</button>
                            {showModal && <Modal onClose={() => setShowModal(false)}><OTPLogin onLoginSuccess={setUser} /></Modal>}

                            <Link to="/register" className="auth-link">Register</Link>
                        </>
                    )}
                    <button className="cart-btn" onClick={() => setCartOpen(true)}>🛒 Cart</button>
                </div>
            </header>
            ...
            <div className={`cart-container ${cartOpen ? "open" : ""}`}>
                <CartPopup isOpen={cartOpen} cartItems={cartItems} onClose={() => setCartOpen(false)} />
            </div>
